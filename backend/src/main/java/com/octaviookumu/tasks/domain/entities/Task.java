...
public class Task {
    ...
    @ManyToOne(fetch = FetchType.LAZY) // taskList won't be loaded from db until actually needed
    @JoinColumn(name = "task_list_id") // foreign key column name in the tasks table (id of taskList)

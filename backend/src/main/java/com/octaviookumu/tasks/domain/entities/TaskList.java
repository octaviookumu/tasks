...
public class TaskList {
    ...
    }) // i.e. look to taskList on Task for more info
    // CascadeType.REMOVE - when we remove a taskList all tasks are removed
    // CascadeType.PERSIST - when we save a task list its tasks are saved too
